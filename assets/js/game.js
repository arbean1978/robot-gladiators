  ...
  //if player is not alive break out of the loop
    ...
    var endGame = function () {
     ...
     if (playerInfo.money > highScore) {
       ...
       alert(playerInfo.name + " did not bea the high score of " + highScore + ". Maybe next time!");
     }
    ...
    switch (shopOptionPrompt) {
      ...
      default:
        ...
        //call shop() again to force player to pic a valid option
        shop();
        break;
      }
    };
